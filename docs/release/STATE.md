...
- [ ] Owner: release tester; Target condition: close or explicitly defer live validation for each documented hardware tier (16gb, 24gb, 32gb, 64gb, gemma-*) by recording release evidence in `docs/release/MANUAL_VALIDATION.md` or adding a release-state deferral that names why the tier is not beta-blocking
