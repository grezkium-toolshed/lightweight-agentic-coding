...
## Release gates
- Linux CI workflow (`.github/workflows/ci.yml`) is green for the current branch
- runtime scripts validated on macOS and Linux, with Windows validated locally from a fresh clone until native PowerShell CI coverage returns
