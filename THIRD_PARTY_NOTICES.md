...
| [Opencode-DCP/opencode-dynamic-context-pruning](https://github.com/Opencode-DCP/opencode-dynamic-context-pruning) | `@tarquinen/opencode-dcp@3.1.9` is referenced by generated OpenCode configs for dynamic context pruning. | npm metadata reports AGPL-3.0-or-later. Fetched by OpenCode on first use (requires network); not vendored in the wheel. |
